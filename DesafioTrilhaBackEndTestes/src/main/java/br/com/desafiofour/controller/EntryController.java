...
public class EntryController {
	...
	@ApiOperation("Filtrar")
	@GetMapping("/filter")
	public ResponseEntity<List<Entry>> getLancamentosDespendentes(

			@RequestParam(value = "data_lancamento", required = false) String data_lancamento,
			@RequestParam(value = "amount", required = false) String amount,
			@RequestParam(value = "paid", required = false) boolean paid) {

		List<Entry> entry = null;

		entry = entryService.getLancamentosDependentes(data_lancamento, amount, paid);
	...
	public ResponseEntity<Integer> calcula(@RequestParam Integer x, @RequestParam Integer y) {
		...
		Integer media = entryService.calculaMedia(x, y);
